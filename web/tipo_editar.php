...
if (!$t) die("Tipo de equipo no encontrado.");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errores) {
        $stmtUp = $pdo->prepare(
            "UPDATE tipos_equipo SET nombre = ?, descripcion = ? WHERE id = ?"
        );
...
<div class="container mt-4">
    ...
    <form method="post">
        ...
        <a href="admin_catalogos.php?tab=tipos" class="btn btn-secondary">Volver</a>
    </form>
</div>
