...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errores) {
        ...
        try {
            ...
            $errores[] = 'Error al guardar la SIM: ' . $e->getMessage();
        }
    }
}
    ...
    <form method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-text">Puedes adjuntar contratos, documentación del operador o cualquier otro fichero.</div>
            </div>
        </div>
